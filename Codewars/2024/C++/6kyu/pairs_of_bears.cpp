 ...
 * returning a list/array of the string containing valid mating pairs 
 * and a boolean indicating whether the total number of bears is greater than or equal to x.
 *
...
std::pair<std::string, bool> bears(int x, const std::string &s) {
    ...
    return std::make_pair(pairs, count >= x);
}
