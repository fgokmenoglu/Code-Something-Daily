 ...
 * For example: task("Monday", 15, 2) -> "It is Monday today, James, you have to work, you must spray 15 trees and you need 30 dollars to buy liquid"
 */
#include <string>
#include <map>

std::string task(std::string day_of_week, int n, int c) {
  std::map<std::string, std::string> dayWorker = {
    {"Monday", "James"},
    {"Tuesday", "John"},
    {"Wednesday", "Robert"},
    {"Thursday", "Michael"},
  ...
  return "It is " + day_of_week + " today, " + dayWorker[day_of_week] + 
    ", you have to work, you must spray " + std::to_string(n) + " trees and you need " + 
    std::to_string(n * c) + " dollars to buy liquid";
}
