...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
  ...
  var month = 1;
  var target = startPriceNew - startPriceOld;
  var difference = target;
  
  do {
    target = target * (100 - percentLossByMonth) / 100;
    console.log(target);
    difference = target - savingperMonth * month;
  ...
  return [month - 1, Math.round(Math.abs(difference))];
}
// ALTERNATIVE
/*
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
